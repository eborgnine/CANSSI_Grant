...
\begin{enumerate}
  ...
  \item Clarify how the team will function and how team members will interact and collaborate. Describe the roles of the lead investigators in the project and research.
  ...
  \item Provide more details on how the aims associated with the application are related to the statistical methodology.
  ...
  \item Briefly describe the available data sets and the confounders present therein.
  ...
  \item Discuss why you model mortality from asthma, rather than occurrence.
  ...
  \item Detail the technical challenges to be addressed, provide references to what is already known and clearly state what is to be developed. In your discussion, include the following.
  
  \begin{enumerate}
  \item Provide explicit information on the kinds of constraints you will place on the prior distributions. Provide more extensive references to the literature on shape constrained models.
  ...
  \item Describe the challenges of introducing Bayesian approaches.
  ...
  \item You propose to initiate the models in STAN. Does this mean the research is very straightforward? If not, what are the challenges?
...
\begin{enumerate}
  \item From a methodological perspective, the proposed extensions are not particularly novel. However, the application of Bayesian nonparametric regression in the context of air pollution epidemiology is novel.
...
\begin{enumerate}
  ...
  \item The naive case fatality rate that the investigators plan to explore with regard to Objective 3 is subject to errors caused by an undercount of both the numerator and the denominator and known to be a poor measure of the mortality risk of the disease.
