...
We will develop a fully Bayesisan implementation of the *groupwise additive index model* (GAIM), a constrained frequentist version of which is introduced in @pierre2020aim. For a response distribution $D$, parameter $\theta = (\theta_{1},\ldots,\theta_{d})$, and link function $g$, the GAIM is,
